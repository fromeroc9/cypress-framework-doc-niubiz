import{_ as i,r as t,o as l,c,a as e,b as a,d as r,e as s}from"./app.7262a81b.js";var d="/cypress-framework-doc-niubiz/images/empezar/launchpad.png",o="/cypress-framework-doc-niubiz/images/empezar/browser.png";const u={},p=r(`<h2 id="instalacion" tabindex="-1"><a class="header-anchor" href="#instalacion" aria-hidden="true">#</a> Instalaci\xF3n</h2><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># clone project</span>
...
<span class="token function">git</span> clone https://<span class="token operator">&lt;</span>username<span class="token operator">&gt;</span>@bitbucket.org/VisaNet_TI/framework-cypress.git
<span class="token comment"># access folder</span>
<span class="token builtin class-name">cd</span> framework-cypress
